...
{
    Q_OBJECT
    Q_PROPERTY(double valueRange READ getValueRange WRITE setValueRange)
    Q_PROPERTY(double valueStep READ getValueStep WRITE setValueStep)
...
private:
    double value;                   //目标值
    double valueRange;        //目标值范围
    double valueStep;           //目标值步进
