...
void GaugePanel::drawScale(QPainter *painter)
{
    ...
    painter->rotate(30);
    int steps = int(valueRange / valueStep);
    // int steps = (30);
...
void GaugePanel::drawScaleNum(QPainter *painter)
{
    ...
    for (int i = 0; i <= 10; i++) {
        ...
        double value = 1.0 * i * ((valueRange) / 10);//刻度值范围
...
void GaugePanel::drawPointer(QPainter *painter)
{
    ...
    painter->rotate(30+int(value*valueStep*300/valueRange));
    QPen pen = painter->pen();
    pen.setWidthF(1.0);
...
void GaugePanel::drawPointerSector(QPainter *painter)
{
    ...
    painter->drawPie(rect, -120*16, -int(value*16*valueStep*300/valueRange));
...
double GaugePanel::getValueRange() const
{
    return this->valueRange;
}

double GaugePanel::getValueStep() const
{
...
void GaugePanel::setValueRange(double valueRange) {
    this->valueRange = valueRange;
}

void GaugePanel::setValueStep(double valueStep) {
